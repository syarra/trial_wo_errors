...
%Read in a constraint-based model
%
% :Usage:
...
%
%   - `fileName`
%          File name for file to read in
%
%   defaultBound
%       Default value for maximum flux through a reaction if
%       not given in the SBML file (Default = 1000)
%
%   fileType            File type for input files: 'SBML', 'SimPheny', or 'SimPhenyPlus', 'SimPhenyText' (Default = 'SBML')
...
% ::
%
%   model = readCbModel;  % Load a file to be specified in a dialog box
%
%   model = readCbModel('iJR904', 1000, 'SBML');  % Load model named 'iJR904' in SBML format with maximum flux set
%                                                 % at 1000 (requires file named 'iJR904.xml' to exist)
%
%   model = readCbModel('iJR904', 500, 'SimPheny');  % Load model named 'iJR904' in SimPheny format with maximum flux set
%                                                    % at 500 (requires files named 'iJR904.rxn', 'iJR904.met', and 'iJR904.sto' to exist)
%
%   model = readCbModel('iJR904', 500, 'SimPhenyPlus');  % Load model named 'iJR904' in SimPheny format with gpr and compound information
...
% Read a SimPheny metabolic model
%
% :Usage:
% ::
%
